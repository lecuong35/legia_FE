...
export default defineComponent ({
    components: { AdminLayout, CartItem, TextField, BillModal },
    ...
    setup() {
        ...
        var logged_in = ref(ls.get('token_admin') == null);
        ...
        onBeforeMount(async () => {
            if (logged_in.value) {
                ...
                await store.dispatch('bill/adminGetBill', id).then(() => {
